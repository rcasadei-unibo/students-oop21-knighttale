...
public final class JavaFXApp extends Application {
	...
	private EntityFactory factory = new EntityFactoryImpl();	//final
    ...
    public void start(final Stage stage) throws IOException {
        ...
        CharacterController<? extends CharacterModel, ? extends AnimatedEntityView> player = factory.getPlayer();    
        var collision = new CollisionManagerImpl(factory.getEntityManager().getEntities(), WIDTH_WINDOW, HEIGHT_WINDOW);
